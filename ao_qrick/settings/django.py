"""
Django settings for ao_qrick project.
...
SECRET_KEY = 'emw8#lj527&4j0toai3dy*oan0l1tmms&j+00(2sfq)n#f^vmx'
...
WSGI_APPLICATION = 'ao_qrick.wsgi.application'
